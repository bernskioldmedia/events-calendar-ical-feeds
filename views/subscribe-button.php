...
<div class="ecif-subscription tribe-events-c-ical tribe-common-b2 tribe-common-b3--min-medium" x-data="{open:false}">
	...
	<div class="ecif-subscription-info" x-show="open" x-transition x-cloak>
		...
		<p><?php esc_html_e( 'When asked, you will need to provide the following URL:', 'events-calendar-ical-feeds' ); ?></p>
		<div class="ecif-subscription-info__actions">
			<input class="js-copy-tec-ical-feed-url ecif-subscription-info__url" readonly value="<?php echo esc_attr( \BernskioldMedia\WP\EventsCalendarIcalFeeds\Endpoints::get_feed_url() ); ?>" />
			<button class="js-copy-tec-ical-feed-button ecif-subscription-info__copy"><?php esc_html_e( 'Copy', 'events-calendar-ical-feeds' ); ?></button>
		</div>
