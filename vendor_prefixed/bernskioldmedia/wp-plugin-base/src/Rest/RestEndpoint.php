 ...
 * @since   1.0.0
 */
namespace ECIF_Vendor\BernskioldMedia\WP\PluginBase\Rest;

use ECIF_Vendor\BernskioldMedia\WP\PluginBase\Interfaces\RestEndpointInterface;
...
abstract class RestEndpoint extends \WP_REST_Controller implements RestEndpointInterface
{
     ...
     */
    protected function get_filter_value(\ECIF_Vendor\WP_REST_Request $request, string $key) : ?string
    {
